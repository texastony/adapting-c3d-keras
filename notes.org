...
** TODO Generate Training samples: 2 hr
   - Jeff wants five classes: ['Nothing', 'micromanipulator',
     'phacoemulsifier handpiece', 'irrigation/aspiration
     handpiece','capsulorhexis cystotome']
...
** TODO Train Top Layers: 4 hr
   - Going to go in straight TF as I think I can better manage GPUs
     there
** TODO Random Picking of training and Validation: 2 hrs
